 ...
 */
public class Start {
	//pola statyczne na których port bêdzie nas³uchiwa³
	private static final Integer PORT = 8910;
	private static final Integer GatePORT = 8911;//bramka informuj¹ca o tym czy mo¿na wykonaæ komendê
	private static final Integer RespondPORT = 8912;//port odpowiedzi
	
	private static final Integer TIME_OUT = 3600 * 1000;//po 5 minutach jeœli u¿ytkowanik nie wykona ruchu to siê roz³¹czy

	public static void main(String[] args) {//uruchomienie metody startserver
		startServer();
	}
	...
	private static void startServer() {
		...
		try {
			...
			// strumienie wejœæ u¿ytkowników wypisywanie
