...
public class GameTable {
	...
	class Checker extends Thread{//sczytuje informacje wysy³ane z servera na tamt bramki
		BufferedReader in;
		PrintWriter out;
		...
		public void run() {//sprawdza czy bramka jest otwarta puszcza kartê na server, thred odpowiedzialny jest za otwieranie i zamykanie bramki
			try {
				while(true) {
